...
//	public static List<Note> readItems(final Context context) {
//		Observable<List<Note>> observable = Observable.defer(new Func0<Observable<List<Note>>>() {
//			@Override public Observable<List<Note>> call() {
//
//				List<Note> notes = AppDatabase.getAppDatabase(context).userDao().getAll();
